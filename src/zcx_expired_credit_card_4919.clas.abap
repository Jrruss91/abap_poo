CLASS zcx_expired_credit_card_4919 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF car_expired,
        msgid TYPE symsgid VALUE 'ZMC_001_4919',
...
CLASS zcx_expired_credit_card_4919 IMPLEMENTATION.
